...
elseif (strpos($combined_status, 'FOR DISPATCH') !== false || strpos($combined_status, 'FOR-DISPATCH') !== false || strpos($combined_status, 'ONGOING') !== false || strpos($combined_status, 'ROUTED') !== false || strpos($combined_status, 'SENT') !== false) { $level = 4; }
elseif (strpos($combined_status, 'APPROV') !== false && strpos($combined_status, 'FOR') === false) { $level = 3; }
elseif (strpos($combined_status, 'APPROVAL') !== false) { $level = 2; }
...
<div class="dashboard-inner p-4">
    ...
    <div class="row g-4">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <div class="info-box">
                            ...
                            <div class="info-value fw-normal"><?= htmlspecialchars($doc['particulars'] ?? 'N/A') ?></div>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="info-box">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <div class="info-box">
                                ...
                                <div class="info-value"><?= htmlspecialchars(trim($doc['c_fname'] . ' ' . $doc['c_lname'])) ?></div>
                            </div>
                        </div>
                    </div>
                <?php endif; ?>
        ...
        <div class="col-lg-4">
            <div class="bg-white rounded-4 shadow-sm p-4 border h-100">
                <h5 class="fw-bold text-dark mb-1"><i class="fa-solid fa-clock-rotate-left me-2 text-secondary"></i> Activity Log</h5>
                            ...
                            <div class="history-box shadow-sm">
                                ...
                                <div class="pt-2 border-top mt-2 d-flex align-items-center">
                                    ...
                                    <div style="font-size: 0.75rem;">
                                        ...
                                        <div class="text-muted"><?= htmlspecialchars($log['division_name'] ?? 'System') ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
