        ...
        <div class="row g-3 mb-3">
            <div class="col-md-3">
                <div class="data-group">
                    ...
                    <p class="data-value <?= $is_overdue ? 'text-danger fw-bold' : 'text-dark' ?>"><?= !empty($doc['due_date']) ? date('M d, Y', strtotime($doc['due_date'])) : 'None' ?></p>
                </div>
            </div>
            <div class="col-md-3">
                <div class="data-group">
        ...
        <div class="row g-3 mb-3">
            ...
            <div class="col-md-6">
                <div class="data-group">
                    ...
                    <div class="data-value textarea-style bg-light text-dark py-2 px-3 border-0"><?= $dest_names_html ?></div>
                </div>
            </div>
        </div>
