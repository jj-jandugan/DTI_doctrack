        ...
        <div class="row g-4">
            ...
            <div class="col-lg-8">
                ...
                <h6 class="border-bottom pb-2 mb-2 text-secondary mt-4" style="font-size: 0.9rem;"><i
                        class="fa-solid fa-location-dot me-2"></i>Destination Information</h6>
                <div class="row g-3 mb-3">
                    <div class="col-md-6">
                                    ...
                                    <div class="activity-card">
                                        ...
                                        <div class="log-footer">
                                            ...
                                            <div class="user-details">
                                                <span
                                                    class="user-name"><?= htmlspecialchars($log['first_name'] . ' ' . $log['last_name']) ?></span>
                            ...
                            <?php if (count($history_logs) > 4): ?>
                                <div class="text-center">
                                    <button type="button" id="toggleLogsBtn"
                                        class="btn btn-sm btn-link fw-bold text-decoration-none text-primary"
                                        onclick="toggleActivityLogs()"> Show More </button>
                                </div>
                            <?php endif; ?>
                        <?php endif; ?>
                    </div>
            ...
            <div class="footer-action-container pt-3 border-top mt-4 d-flex justify-content-between align-items-center">
                <div class="created-info">
                    <div class="fw-bold text-dark small">Created By: <span
                            class="text-primary"><?= htmlspecialchars($doc['c_fname'] . ' ' . $doc['c_lname']) ?></span>
                    </div>
                ...
                <?php if ($level < 5 && !$is_rejected): ?>
                    <div class="d-flex gap-2">
                        <button type="button" class="btn btn-blue btn-sm px-4 py-2 fw-bold" data-bs-toggle="modal"
                ...
                <div class="modal-content custom-modal" style="border: 2px solid #0d6efd;">
                    <form action="../../controllers/dispatch.php" method="POST">
                        <div class="modal-body text-center p-4">
                            ...
                            <p class="text-muted" style="font-size: 0.9rem;">Are you sure you want to mark document
                                <b><?= htmlspecialchars($doc['dts_no']) ?></b> as dispatched? This will officially CLOSE the
                                document.</p>
