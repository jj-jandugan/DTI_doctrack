...
if ($is_rejected) {
    ...
    $level = 5;
} elseif (strpos($combined_status, 'ROUTED') !== false || $doc['status_category'] === 'APPROVED') {
    $level = 4;
} elseif (strpos($combined_status, 'FOR DISPATCH') !== false || strpos($combined_status, 'FOR-DISPATCH') !== false || strpos($combined_status, 'SENT') !== false) {
    $level = 4;
...
?> <div class="dashboard-inner p-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <form action="../../controllers/reuseDocument.php" method="POST" class="m-0">
            ...
            <button type="submit" class="btn btn-outline-primary btn-sm fw-bold shadow-sm px-3"
                onclick="return confirm('Reuse this record?')">
                <i class="fa-solid fa-copy me-1"></i> Reuse Record </button>
        </form>
    </div>
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        <div class="info-box">
                            ...
                            <div class="info-value text-primary"><?= htmlspecialchars($doc['class_name'] ?? 'N/A') ?>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="info-box">
                            ...
                            <div class="info-value fw-normal" style="white-space: pre-wrap;">
                                <?= htmlspecialchars($doc['particulars'] ?? 'No particulars provided.') ?></div>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="info-box">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                <div class="info-box">
                                    ...
                                    <div class="info-value small"><?= htmlspecialchars($doc['address_name'] ?? 'N/A') ?>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
