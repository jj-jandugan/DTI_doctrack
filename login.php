...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($username) && !empty($password)) {
        try {
            // FIX 1: Added u.must_change_password to the SELECT query
            $stmt = $pdo->prepare("
                SELECT u.id, u.password, u.first_name, u.last_name, u.must_change_password, p.role, p.division_id
                FROM auth_user u
            ...
            if ($user && password_verify($password, $user['password'])) {
                ...
                // FIX 2: Store the force-change flag in the active session!
    ...
    <div class="login-container">
        <div class="login-card">
            ...
            <form method="post" action="login.php">
                ...
                <a href="forgotPassword.php" class="forgot-password text-decoration-none fw-bold" style="font-size: 0.8rem; color: #1d4ed8;">Forgot Password</a>
