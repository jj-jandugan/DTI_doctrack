        ...
        <div class="row g-4">
            <div class="col-md-8">
                ...
                <div class="data-group mb-4">
                    ...
                    <div class="textarea-style"><?= htmlspecialchars($doc['particulars'] ?? 'No additional notes.') ?></div>
                </div>
                    ...
                    <div class="mt-2">
                        ...
                        <?php else: ?>
                            <?php foreach($attachments as $file): ?>
                                <a href="<?= BASE_URL . $file['file_path'] ?>" target="_blank" class="attachment-link d-block mb-2">
            ...
            <div class="col-md-4 border-start ps-4">
                <div class="data-group mb-3">
                    ...
                    <div class="data-value fw-bold text-success"><?= htmlspecialchars($doc['address_name'] ?? 'External') ?></div>
                </div>
                <div class="data-group mb-3">
                ...
                <div class="data-group mb-4">
                    ...
                    <div class="data-value text-danger fw-bold"><?= $doc['due_date'] ? date('M d, Y', strtotime($doc['due_date'])) : 'None' ?></div>
                </div>
                ...
                <div class="border-top pt-4">
                    ...
                    <form method="POST" action="../../controllers/dispatch.php">
                        ...
                        <button type="submit" class="btn btn-accept w-100" onclick="return confirm('Mark as Dispatched?')">
