                            ...
                            <?php if (empty($history_docs)): ?>
                                <tr>
                                    <td colspan="9" class="text-center text-muted py-5">
                                        <i class="fa-solid fa-folder-open mb-3 opacity-25"
                                            style="font-size: 3.5rem;"></i><br>
                            ...
                            <?php else: ?>
                                <?php foreach ($history_docs as $doc):
                                    ...
                                    <tr class="history-row clickable-row" data-dts="<?= htmlspecialchars($doc['dts_no']) ?>"
                                        ...
                                        <td><?= $doc['due_date'] ? date('M d, Y', strtotime($doc['due_date'])) : '<span class="text-muted">None</span>' ?>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="fw-bold"><?= date('M d, Y', strtotime($doc['updated_at'])) ?></div>
                                        </td>
                                        <td class="fw-bold text-dark text-truncate search-target" style="max-width: 200px;">
                                        ...
                                        <td class="text-truncate search-target">
                                            ...
                                            <?php else: ?>
                                                <span
                                                    class="text-success fw-bold"><?= htmlspecialchars($doc['address_name']) ?></span>
                                            <?php endif; ?>
                                        </td>
                                        <td><?= htmlspecialchars(trim(($doc['sig_fname'] ?? '') . ' ' . ($doc['sig_lname'] ?? 'RD'))) ?>
                                        </td>
                                        <td><span class="creator-name small"><?= htmlspecialchars($doc['c_fname']) ?></span>
                                        </td>
        ...
        <div class="side-panel-section" id="sidePanel">
            ...
            <div class="side-panel-body">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-6">
                        <div class="panel-label">DATE FINALIZED</div>
