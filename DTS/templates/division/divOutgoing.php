...
?> <div class="dashboard-inner p-4">
    ...
    <div class="mb-4">
        ...
        <p class="text-secondary">Draft, manage, and route documents originating from your division for approval or
            release.</p>
    </div>
                    ...
                    <?php else: ?>
                        <?php foreach ($outgoing_docs as $doc): ?>
                            <tr class="doc-row clickable-row"
                                onclick="window.location.href='divEditDocu.php?id=<?= $doc['id'] ?>'" style="cursor: pointer;">
                                ...
                                <td>
                                    <?php if ($doc['due_date']): ?>
                                        <span class="text-dark small"><i class="fa-regular fa-calendar-xmark me-1"></i>
                                ...
                                <td class="text-truncate small" style="max-width: 200px;"
                                    title="<?= htmlspecialchars($doc['sender'] ?? '') ?>">
                                    <?= htmlspecialchars($doc['sender'] ?? '---') ?>
                                </td>
                                <td class="small">
                                    <?= htmlspecialchars(trim(($doc['sig_fname'] ?? '') . ' ' . ($doc['sig_lname'] ?? '---'))) ?>
                                </td>
...
<!-- NEW DOCUMENT MODAL -->
<div class="modal" id="newDocModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content custom-modal">
            <div class="modal-header border-0 pb-0 pt-4 px-4">
                <h5 class="modal-title fw-bold" style="color: #1e293b; font-size: 1.25rem;">
                    <span style="color: #263D81;"><i class="fa-solid fa-file-circle-plus me-2"></i></span> Encode New
                    Outgoing
                </h5>
                ...
                <form method="POST" action="../../controllers/Outgoing.php" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="subject" class="form-control custom-input" rows="2"
                            placeholder="Enter document subject..." required></textarea>
                    </div>
                    <!-- ROUTING SECTION -->
                    <div class="form-section bg-light border p-3 rounded mb-3">
                        <label class="form-label fw-bold text-primary mb-3 small"><i class="fa-solid fa-route me-1"></i>
                        ...
                        <div id="block-external" class="routing-block d-none">
                            <div class="row g-2">
                                <div class="col-md-6">
                                    <input type="text" class="form-control custom-input" name="ext_office"
                                        placeholder="Office / Agency Name">
                                </div>
                                <div class="col-md-6">
                                    <input type="text" class="form-control custom-input" name="ext_name"
                    ...
                    <div class="row g-3 mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="particulars" class="form-control custom-input"
                    ...
                    <div class="mb-4">
                        ...
                        <div class="drag-drop-box" id="dropZone"
                            style="cursor: pointer; border: 2px dashed #d1d5db; border-radius: 8px; padding: 20px;">
...
<div class="modal" id="cancelConfirmModal" tabindex="-1" aria-hidden="true" style="z-index: 1070;">
