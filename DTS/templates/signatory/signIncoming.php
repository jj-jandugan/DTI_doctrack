...
?> <div class="dashboard-inner p-4">
    ...
    <div class="filter-bar mb-4 d-flex align-items-center gap-3 flex-wrap">
        <div class="input-group" style="width: 250px;">
            <span class="input-group-text search-icon-group bg-white border-end-0"><i
                        ...
                        <tbody>
                            <?php foreach ($incoming_docs as $doc):
                                ...
                                <tr class="doc-row clickable-row" style="cursor: pointer;"
                                    ...
                                    data-id="<?= (int) $doc['id'] ?>" data-dts="<?= htmlspecialchars($doc['dts_no']) ?>"
                                    ...
                                    <td class="text-truncate fw-bold text-dark search-target">
                                        <?= htmlspecialchars($doc['subject']) ?>
                                    </td>
                                    <td><span
                                            class="small fw-bold"><?= htmlspecialchars($doc['c_fname'] . ' ' . $doc['c_lname']) ?></span>
                                    </td>
                                    <td>
                            ...
                            <?php if (empty($incoming_docs)): ?>
                                <tr>
                                    <td colspan="6" class="text-center py-5 text-muted">No pending incoming documents.</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
        ...
        <div class="side-panel-section" id="sidePanel">
            ...
            <div class="side-panel-body">
                ...
                <div class="data-group mb-4">
                    ...
                    <div id="paneDestined" class="fw-bold text-success p-2 bg-white border rounded"
                        style="border-color: #bbf7d0 !important;"></div>
                </div>
