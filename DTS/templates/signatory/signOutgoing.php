                    ...
                    <table class="data-table" id="outgoingTable">
                        ...
                        <tbody>
                            ...
                            <tr class="doc-row clickable-row" style="cursor: pointer;"
                                ...
                                <td class="fw-bold text-dark text-truncate search-target"><?= htmlspecialchars($doc['subject']) ?></td>
                                <td>
                                    <div class="creator-cell m-0 p-0 bg-transparent border-0">
                                        <div class="creator-avatar" style="width: 28px; height: 28px;"><i class="fa-solid fa-user" style="font-size: 0.7rem;"></i></div>
                            ...
                            <?php if (empty($outgoing_docs)): ?>
                                <tr><td colspan="6" class="text-center text-muted py-5">No outgoing documents waiting for signature.</td></tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
                </div>
        ...
        <div class="side-panel-section" id="sidePanel">
            ...
            <div class="side-panel-body">
                ...
                <div class="row g-2 mb-3">
                    <div class="col-6"><div class="data-group"><label>Date Drafted</label><div class="data-value" id="paneCreated"></div></div></div>
                    <div class="col-6"><div class="data-group"><label>Deadline</label><div class="data-value text-danger fw-bold" id="paneDeadline"></div></div></div>
                </div>

                <div class="row g-2 mb-3 border-top pt-3">
                    <div class="col-6"><div class="data-group"><label>Classification</label><div class="data-value" id="paneClass"></div></div></div>
                    <div class="col-6"><div class="data-group"><label>Routing Path</label><div class="data-value text-primary fw-bold" id="paneRouteType"></div></div></div>
                </div>
                ...
                <div class="row g-2 mb-4">
                    <div class="col-12"><div class="data-group"><label>Address (Destination)</label><div class="data-value textarea-style" style="min-height:40px;" id="paneAddress"></div></div></div>
                ...
                <div class="border-top pt-4">
                    <div class="mb-3">
                        <p class="mb-0 text-muted" style="font-size: 0.75rem;">Drafted by: <span class="fw-bold text-dark" id="paneCreator"></span> (<span id="paneCreatorDiv"></span>)</p>
                    </div>
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <form method="POST" action="../../controllers/signatory.php" class="m-0 w-50">
                            ...
                            <button type="submit" class="btn btn-red w-100" onclick="return confirm('Reject this outgoing document?');">
                        ...
                        <form method="POST" action="../../controllers/signatory.php" class="m-0 w-50">
                            ...
                            <input type="hidden" name="document_id" class="targetDocId">
                            <button type="submit" class="btn btn-blue w-100" onclick="return confirm('Approve this document for release?');">
