...
<div class="modal fade" id="addDivisionModal" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered"><div class="modal-content custom-modal">
        <div class="modal-header border-0 pb-0 pt-4 px-4"><h5 class="fw-bold text-dark"><i class="fa-solid fa-building me-2" style="color: #263D81;"></i> Add Division</h5><button type="button" class="btn-close shadow-none" data-bs-dismiss="modal"></button></div>
        <div class="modal-body px-4 py-4"><form method="POST"><input type="hidden" name="action" value="add_division"><input type="hidden" name="active_tab" value="divisions">
            <div class="mb-3"><label class="form-label modal-label">Abbreviation *</label><input type="text" name="abbreviation" class="form-control custom-input" required></div>
            <div class="mb-4"><label class="form-label modal-label">Full Name *</label><input type="text" name="name" class="form-control custom-input" required></div>
            <div class="d-flex justify-content-end gap-2 border-top pt-3"><button type="button" class="btn btn-cancel" data-bs-dismiss="modal">Cancel</button><button type="submit" class="btn btn-blue px-4">Save</button></div>
        </form></div>
    </div></div>
</div>
...
<div class="modal fade" id="addStatusModal" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered"><div class="modal-content custom-modal">
        <div class="modal-header border-0 pb-0 pt-4 px-4"><h5 class="fw-bold text-dark"><i class="fa-solid fa-tag me-2" style="color: #263D81;"></i> Add Status</h5><button type="button" class="btn-close shadow-none" data-bs-dismiss="modal"></button></div>
        <div class="modal-body px-4 py-4"><form method="POST"><input type="hidden" name="action" value="add_status"><input type="hidden" name="active_tab" value="statuses">
            <div class="mb-3"><label class="form-label modal-label">Name *</label><input type="text" name="name" class="form-control custom-input" required></div>
            <div class="mb-4"><label class="form-label modal-label">Category *</label><select name="category" class="form-select custom-input" required><option value="ONGOING">ONGOING</option><option value="FOR-APPROVAL">FOR APPROVAL</option><option value="CLOSED">CLOSED</option></select></div>
            <div class="d-flex justify-content-end gap-2 border-top pt-3"><button type="button" class="btn btn-cancel" data-bs-dismiss="modal">Cancel</button><button type="submit" class="btn btn-blue px-4">Save</button></div>
        </form></div>
    </div></div>
</div>
...
<div class="modal fade" id="editClassModal" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered"><div class="modal-content custom-modal"><div class="modal-body p-4">
        <h5 class="fw-bold mb-4">Edit Classification</h5>
        <form method="POST"><input type="hidden" name="action" value="edit_classification"><input type="hidden" name="active_tab" value="classifications"><input type="hidden" name="id" id="editClassId">
            <input type="text" name="name" id="editClassName" class="form-control custom-input mb-4" required>
            <div class="d-flex justify-content-end gap-2"><button type="button" class="btn btn-cancel" data-bs-dismiss="modal">Cancel</button><button type="submit" class="btn btn-blue px-4">Update</button></div>
        </form>
    </div></div></div>
</div>
...
<div class="modal fade" id="editTypeModal" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered"><div class="modal-content custom-modal"><div class="modal-body p-4">
        ...
        <form method="POST"><input type="hidden" name="action" value="edit_type"><input type="hidden" name="active_tab" value="doctypes"><input type="hidden" name="id" id="editTypeId">
...
<div class="modal fade" id="editDivisionModal" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered"><div class="modal-content custom-modal"><div class="modal-body p-4">
        ...
        <form method="POST"><input type="hidden" name="action" value="edit_division"><input type="hidden" name="active_tab" value="divisions"><input type="hidden" name="id" id="editDivId">
            <div class="mb-3"><label class="form-label">Abbreviation</label><input type="text" name="abbreviation" id="editDivAbbr" class="form-control custom-input" required></div>
            <div class="mb-4"><label class="form-label">Full Name</label><input type="text" name="name" id="editDivName" class="form-control custom-input" required></div>
            <div class="d-flex justify-content-end gap-2"><button type="button" class="btn btn-cancel" data-bs-dismiss="modal">Cancel</button><button type="submit" class="btn btn-blue px-4">Update</button></div>
        </form>
    </div></div></div>
</div>
...
<div class="modal fade" id="editStatusModal" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered"><div class="modal-content custom-modal"><div class="modal-body p-4">
        ...
        <form method="POST"><input type="hidden" name="action" value="edit_status"><input type="hidden" name="active_tab" value="statuses"><input type="hidden" name="id" id="editStatusId">
            <div class="mb-3"><label class="form-label">Status Name</label><input type="text" name="name" id="editStatusName" class="form-control custom-input" required></div>
            <div class="mb-4"><label class="form-label">Category</label><select name="category" id="editStatusCat" class="form-select custom-input" required><option value="ONGOING">ONGOING</option><option value="FOR-APPROVAL">FOR APPROVAL</option><option value="CLOSED">CLOSED</option></select></div>
            <div class="d-flex justify-content-end gap-2"><button type="button" class="btn btn-cancel" data-bs-dismiss="modal">Cancel</button><button type="submit" class="btn btn-blue px-4">Update</button></div>
        </form>
    </div></div></div>
</div>
